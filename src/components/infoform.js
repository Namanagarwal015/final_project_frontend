          ...
          <form className="self-stretch bg-white flex flex-col py-5 px-4 items-start justify-start gap-[24px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[6px] lg:w-1/2">
              <div className="font-medium">First Name</div>
                <input className="self-stretch rounded-lg bg-white py-2.5 px-3.5 text-gray-900 border-[1px] border-solid border-gray-300 leading-[24px] font-medium font-text-sm-medium1 text-[14px] focus:outline-none" type="text" defaultValue="FirstName" placeholder="First Name" />
            </div>
  
            <div className="self-stretch flex flex-col items-start justify-start gap-[6px] lg:w-1/2">
              <div className="font-medium">Last Name</div>
                <input className="self-stretch rounded-lg bg-white py-2.5 px-3.5 text-gray-900 border-[1px] border-solid border-gray-300 leading-[24px] font-medium font-text-sm-medium1 text-[14px] focus:outline-none" type="text" defaultValue="LastName" placeholder="Last Name"/>
            </div>
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
              ...
              <div className="self-stretch rounded-lg border-[1px] border-solid border-gray-300 flex ">
                ...
                <input className="self-stretch rounded-lg border-none bg-white py-2.5 px-3.5 gap-[8px] text-gray-900 leading-[24px] font-medium font-text-sm-medium1 text-[14px] focus:outline-none" type="email" defaultValue="@untitled.com" placeholder="Email"/>
              </div>
            </div>
