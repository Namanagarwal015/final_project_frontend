          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <h2 class="text-md leading-tight tracking-tight font-inter text-gray-900 md:text-md dark:text-black">
              ...
              <div class="space-y-4 md:space-y-6" action="#">
                  <div>
                      <label for="email" class="block mb-2 text-sm font-inter text-gray-900 dark:text-black">Email/Username</label>
                      <input type="text" name="email" id="email" onChange={(e)=>{setEmail(e.target.value)}} class="bg-gray-50 border border-gray-200 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-100 dark:placeholder-gray-900 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your email/Username" required=""/>
                  </div>
                  <div>
                  ...
                  <Link to={`/blogpage/${email}`}><button type="submit" onClick={loginf} class="w-full text-white bg-[#7F56D9] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#7F56D9] dark:hover:bg-primary-600 dark:focus:ring-primary-800">Sign in</button></Link>
